---
mode: agent
description: Review the most recent change and remove unnecessary complexity. Does not add features.
---

Target: ${input:target:File or area to simplify (leave empty for most recent change)}
